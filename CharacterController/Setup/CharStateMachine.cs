...
public class CharStateMachine : MonoBehaviour
{
    ...
    { get { return _grappleLr; } set { _grappleLr = value; } }
    ...
    public bool UpCheck
    { get { return _upCheck; } set { _upCheck = value; } }
    ...
    { get { return _isWalled; } set { _isWalled = value; } }

    [SerializeField] bool _wallRight;
    public bool WallRight
    { get { return _wallRight; } set { _wallRight = value; } }
    ...
    { get { return _wallLeft; } set { _wallLeft = value; } }
    ...
    { get { return _wallNormal; } set { _wallNormal = value; } }

    [SerializeField] Vector3 _wallForward;
    public Vector3 WallForward
    { get { return _wallForward; } set { _wallForward = value; } }
    ...
    { get { return _wallRunDownForce; } set { _wallRunDownForce = value; } }

    [SerializeField] bool _canStartWallTimer;
    public bool CanStartWallTimer
    { get { return _canStartWallTimer; } set { _canStartWallTimer = value; } }
    ...
    { get { return _wallClingTime; } set { _wallClingTime = value; } }

    [SerializeField] Transform _currentWall;
    public Transform CurrentWall
    { get { return _currentWall; } set { _currentWall = value; } }

    [SerializeField] Transform _previousWall;
    public Transform PreviousWall
    { get { return _previousWall; } set { _previousWall = value; } }
    ...
    { get { return _isGrappled; } set { _isGrappled = value; } }
    ...
    { get { return _grappleDirection; } set { _grappleDirection = value; } }

    [SerializeField] int _grappleHooks;
    public int GrappleHooks
    { get { return _grappleHooks; } set { _grappleHooks = value; } }

    [SerializeField] float _grappleDelay;
    public float GrappleDelay
    { get { return _grappleDelay; } set { _grappleDelay = value; } }
    ...
    { get { return _finishedGrapple; } set { _finishedGrapple = value; } }
    ...
    { get { return _isVaulted; } set { _isVaulted = value; } }
    ...
    { get { return _isSliding; } set { _isSliding = value; } }

    [SerializeField] bool _isWallRunning;
    public bool IsWallRunning
    { get { return _isWallRunning; } set { _isWallRunning = value; } }

    [SerializeField] bool _isGrappling;
    public bool IsGrappling
    { get { return _isGrappling; } set { _isGrappling = value; } }
    ...
    private void Awake()
    {
        ...
        // Needed setup for the state machine to work correctly 
    ...
    private void Update()
    {
        ...
        CurrentMovement =
            (Orientation.forward * CurrentMovementInput.y).normalized
            + (Orientation.right * CurrentMovementInput.x).normalized;
    ...
    /// <summary>
    /// Check if its possible to vault
    /// </summary>
    ...
    /// <summary>
    /// Check if the character is sloped
    /// </summary>
    /// <returns></returns>
    bool CheckSloped()
    {
    ...
    /// <summary>
    /// Check while sliding for if you can stop sliding
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns the wall jump direction based on the input direction
    /// </summary>
    ...
    /// <summary>
    /// Returns the slope move direction based on the direction you are moving on the slope
    /// </summary>
    ...
    /// <summary>
    /// When moving left or right slow down movement
    /// </summary>
    ...
    /// <summary>
    /// Controll speed and force for consistent movment
    /// </summary>
